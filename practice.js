...
const mooresBits = bits.map( bitsIndex => bitsIndex * 2 );
...
// The object, that, needs a method that returns the window object. Use an arrow function to do this.
